                    ...
                    >
                        <View className="flex-1 w-full max-w-[500px] self-center justify-between">
                            ...
                            >
                                ...
                                <Text className="text-2xl font-bold text-dark mb-2">Create Account</Text>
                                <Text className="text-sm text-gray-500 mb-8">Start your financial journey</Text>

                                {/* Form */}
                                <View className="w-full gap-4">

                                    <View className="bg-gray-50 rounded-2xl px-4 h-[60px] justify-center border border-gray-100 focus:border-orange-500 w-full">
                                        <TextInput
                                    ...
                                    <View className="flex-row items-center bg-gray-50 rounded-2xl px-4 h-[60px] border border-gray-100 focus:border-orange-500 w-full">
                                        <Text className="text-dark font-medium mr-3 pr-3 border-r border-gray-300 text-lg">{formData.countryCode}</Text>
                                        <TextInput
                                    ...
                                    <TouchableOpacity
                                        className={`w-full h-[60px] bg-orange-500 rounded-2xl items-center justify-center mt-4 shadow-orange-500/30 shadow-lg ${(!formData.fullName || formData.phoneNumber.length < 10) ? 'opacity-50' : ''}`}
                                        onPress={handleSignUp}
                                        disabled={!formData.fullName || formData.phoneNumber.length < 10 || isLoading}
                                    >
                                ...
                                <View className="mt-8 flex-row">
                                    <Text className="text-gray-500 text-sm">Already a member? </Text>
