...
const CATEGORIES = [
    ...
    { id: 4, name: 'Health', icon: 'medkit-outline', color: '#EF4444' },
    { id: 5, name: 'Utility', icon: 'flash-outline', color: '#10B981' },
        ...
        <View className="flex-1 bg-gray-50">
            <SafeAreaView className="flex-1" edges={['top', 'left', 'right']}>
                ...
                <View className="flex-row items-center px-6 py-4">
                    ...
                    <Text className="text-xl font-bold text-[#1E1E2D] ml-4">Add Expense</Text>
                </View>
