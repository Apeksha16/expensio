  ...
  template: `
    <div class="h-full bg-gray-50 p-4 flex flex-col gap-4">
      ...
      <div class="bg-black text-white p-5 border border-black rounded-none">
        <h2 class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">Total Expenses</h2>
      ...
      <div class="flex-1 flex flex-col gap-1.5 pb-16 mt-2">
        ...
        <ng-template #contentArea>
          <ng-container *ngIf="expenseService.expenses().length > 0; else emptyState">
            <button *ngFor="let expense of expenseService.expenses(); trackBy: trackById" 
            ...
            <div #scrollTrigger class="h-10 flex items-center justify-center border-b border-transparent">
              <svg *ngIf="expenseService.hasMore()" class="animate-spin h-6 w-6 text-black" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
          ...
          <ng-template #emptyState>
            <div class="flex-1 flex flex-col items-center justify-center p-8 text-center">
              ...
              <p class="text-gray-400 font-bold text-sm mt-2 max-w-[250px]">Tap the + button below to add your first expense.</p>
            </div>
          </ng-template>
        </ng-template>
