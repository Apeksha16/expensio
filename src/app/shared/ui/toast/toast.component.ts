...
@Component({
  ...
  template: `
    <div class="fixed top-4 left-0 right-0 z-[9999] pointer-events-none flex flex-col items-center gap-2 px-4">
      @for (toast of toastService.toasts(); track toast.id) {
        ...
        >
          ...
          <!-- Close button -->
          <button (click)="toastService.remove(toast.id)" class="flex-shrink-0 text-black/60 hover:text-black transition-colors focus:outline-none">
