...
export default function MobileHeader() {
  ...
  return (
    <header className="relative z-40 bg-shell/80 border-b border-theme-border/40 backdrop-blur-md px-6 py-4 flex items-center justify-between transition-colors duration-300">
