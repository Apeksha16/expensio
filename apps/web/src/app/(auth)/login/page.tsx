...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast("Access granted! Entering Expensio...");
      
      setTimeout(() => {
        router.push('/');
        // Force fully refreshed route navigation to load PWA state
    ...
    <div className="flex items-center justify-center min-h-screen bg-[#09090b] text-gray-100 px-4 relative overflow-hidden select-none">
      ...
      >
        ...
        <div className="relative my-6 flex items-center justify-center">
          ...
          <span className="relative px-3 bg-zinc-900/60 text-zinc-500 text-[10px] font-black uppercase tracking-widest">
            Or continue with
          </span>
        </div>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col gap-0.5">
                          ...
                          <span className="text-[10px] text-zinc-500 font-medium">{account.email}</span>
                        </div>
                      </div>
